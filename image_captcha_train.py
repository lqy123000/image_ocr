# -*- coding: utf-8 -*-
'''CNN+GRU+CTC network for captcha recognition of generated captcha images.
...
class TextImageGenerator(callbacks.Callback):
    ...
    def get_batch(self, index, size, train):
        ...
        for i in range(size):
            ...
            # if train and i > size - 1:
            #     if K.image_data_format() == 'channels_first':
            #         X_data[i, 0, 0:self.img_w, :] = paint_captcha(self.generator, ' ').T
            #     else:
            #         X_data[i, 0:self.img_w, :, 0] = paint_captcha(self.generator, ' ').T
...
if __name__ == '__main__':
    ...
    # RUN_NAME = "GRU"
    SAVE_MODEL_PATH = "./model/image_captcha_test.h5"
